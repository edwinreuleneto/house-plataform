...
export function SidebarLayout({
  ...
  return (
     <div className="flex min-h-svh w-full bg-white pt-4 overflow-hidden">
      ...
      {/* Content */}
      <div className={`flex-1 transition-all duration-500 ease-out mt-0 min-h-screen bg-white rounded-tl-2xl overflow-hidden ${sidebarOpen && !isMobile ? "lg:ml-72" : "ml-0"}`}>
          <Header onMenuClick={handleSidebarToggle} sidebarOpen={sidebarOpen} isMobile={isMobile} />

          <main className="p-4 sm:p-6 lg:p-8 main-content overflow-scroll h-[100%]">
            {children}
          </main>
        </div>
    </div>
