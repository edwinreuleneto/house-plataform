...
const insights = [
  {
    id: 1,
    title: 'O time de vendas reduziu em 23% o tempo de resposta a clientes nas últimas 2 semanas.',
    date: '2025-07-28T09:00Z',
  },
  {
    id: 2,
    title: 'Contrato da XYZ expira em 7 dias e ainda não há movimentação para renovação.',
    date: '2025-07-27T08:15Z',
  },
  {
    id: 3,
    title: 'Baseado nos dados atuais, há 72% de chance de atraso no projeto “Nova Plataforma”.',
    ...
    <section>
      ...
      <div className="overflow-auto rounded-lg border border-gray-100">
        ...
        <thead className="bg-gray-50 text-xs font-semibold text-gray-500 uppercase tracking-wide">
          <tr>
            <th scope="col" className="px-6 py-4 text-left">Título</th>
